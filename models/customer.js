...
//    if(!this.email) return 'https://gravatar.com/avatar/?shttps://gravatar.com/avatar/?s' + size + '&d=retro';
//    var md5 = crypto.createHash('md5').update(this.email).digest('hex');
// return 'https://gravatar.com/avatar/https://gravatar.com/avatar/' + md5 + '?s=' + size + '&d=retro';
// }
